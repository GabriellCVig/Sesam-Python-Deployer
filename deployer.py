...
pipe_templates = ''
def generate_replica(pipe_config):
    input_replica_template = getenv('input_replica')
    output_replica_template = getenv('output_replica')
    pipe_id = pipe_config['_id']
    input_replica = load_json(input_replica_template.replace('##pipe_id##', pipe_id))
    output_replica = load_json(output_replica_template.replace('##pipe_id##', pipe_id))
    return input_replica, output_replica
